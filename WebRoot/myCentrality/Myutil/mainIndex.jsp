	...
	<body>
		<div id="mid" >
					<div id="top">
						...
						<div id="rb"></div>
						<div id="m_left">
							<div id="photo"><img src="<%=path %>/myCentrality/img/u=246153555,11740248&fm=26&gp=0.jpg"/></div>
							<ul>
								<li><a href=""></a>福克斯</li>
								<li><a href=""></a>G15大会员</li>
								<li><a href="">申请达人</a></li>
							</ul>
							<p>资料完成度<a href=""><img src="<%=path %>/myCentrality/img/tiao.png"/>&nbsp;完善</a><br />账户安全<a href=""><img src="<%=path %>/myCentrality/img/a2.png"/> 提升</a></p>
						</div>
						<div id="m_right"> 
				...
				<div id="right">
					...
					<div id="<%=path %>/myCentrality/right_mid">
						<p>会员推荐 会员俱乐部 ></p>
					...
					<div id="right_bot">
						...
						<a href=""><img src="<%=path %>/myCentrality/img/youxia.png"/> <span>游戏</span> </a>
						<hr />
						<table>
							<tr>
								<td colspan="2">
									<span id="bo1">花费充值</span>
									<span id="bo2">流量充值</span>
								 </td>
							</tr>
							<tr>
								<td colspan="2">
